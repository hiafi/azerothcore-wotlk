...
-- faction = 14 (Monster, hostile to both factions -- same value the older TBC-era "Target Dummy"
-- entry 2673 already uses). Everything else is copied verbatim from 30527: rank 3 (worldboss, so
