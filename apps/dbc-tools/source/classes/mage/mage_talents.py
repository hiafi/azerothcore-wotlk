...
# Fire Mage rework (docs/reworks/fire-mage-rework.md) Phase 2 (9,1) Pyromaniac - moved from (6,0). (9,0)/(9,2) intentionally empty.
granted_by_talent(
    id=1733,
    tab=fire_41_tab,
    tier=9,
